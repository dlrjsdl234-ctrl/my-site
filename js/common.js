...
const MENU = [
  ...
  { label: "비석지키기", href: "/pages/tables/tombstone.html" },
  { label: "RP 스킬 데이터", href: "/pages/tables/rpskill-data.html" },
  { label: "RP 스킬 성능", href: "/pages/tables/rpskill-perf.html" },
  { label: "이세계스킬", href: "/pages/tables/isekai-skill.html" },
  { label: "이세계스킬 성능", href: "/pages/tables/isekai-perf.html" },
  { label: "초월정보", href: "/pages/tables/transcend.html" },
  { label: "크뎀계산식", href: "/pages/tables/crit-formula.html" },
